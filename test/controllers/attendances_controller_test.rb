...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference("Attendance.count") do
      post attendances_url, params: { attendance: { schedule_id: @attendance.schedule_id, senator_id: @attendance.senator_id } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { schedule_id: @attendance.schedule_id, senator_id: @attendance.senator_id } }
